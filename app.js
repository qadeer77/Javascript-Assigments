...
// qno#1
// var user = prompt("Enter a Character i.e. : a-z,A-Z,0-9");
// var asciiCode = user.charCodeAt();
// if (asciiCode >= 65 && asciiCode <= 90){
//     document.write(user + " is a uppercase letter");
// }
// else if(asciiCode >= 97 && asciiCode <= 122){
//     document.write(user + " is a lowercase letter");
// }
// else if (asciiCode >= 48 && asciiCode <= 57){
//     document.write(user + " is a number");
// }
// else [
//     alert("Invalid input")
// ]
...
// qno#01
// var first = prompt("Enter your ist name");
...
// var userInput = prompt("Welcome to GM Bakery. What do you want to order sir/ma'am?").toLowerCase();
// var flag = true;
